          ...
          <AutoColumn gap="12px">
            ...
            <FixedHeightRow onClick={() => setShowMore(!showMore)}>
              <RowFixed>
                ...
                <Text color={theme.text2} fontWeight={500} fontSize={20}>
    ...
    <HoverCard border={border}>
      <AutoColumn gap="12px">
        <FixedHeightRow onClick={() => setShowMore(!showMore)} style={{ cursor: 'pointer' }}>
          ...
          <RowFixed>
            {showMore ? (
              <ChevronUp color={theme.text2} size="20" style={{ marginLeft: '10px' }} />
            ) : (
              <ChevronDown color={theme.text2} size="20" style={{ marginLeft: '10px' }} />
            )}
          </RowFixed>
        </FixedHeightRow>
        {showMore && (
          <AutoColumn gap="8px">
            <FixedHeightRow>
              <RowFixed>
                <Text color={theme.text2} fontSize={16} fontWeight={500}>
                  Pooled {currency0.symbol}:
                </Text>
              </RowFixed>
              {token0Deposited ? (
                <RowFixed>
                  <Text color={theme.text2} fontSize={16} fontWeight={500} marginLeft={'6px'}>
                    {token0Deposited?.toSignificant(6)}
                  </Text>
