...
import { Currency, currencyEquals, OMC, Percent, WOMC } from '@uniswap/sdk'
...
export default function RemoveLiquidity({
  ...
  const oneCurrencyIsOMC = currencyA === OMC || currencyB === OMC
  const oneCurrencyIsWOMC = Boolean(
    chainId &&
      ((currencyA && currencyEquals(WOMC[chainId], currencyA)) ||
        (currencyB && currencyEquals(WOMC[chainId], currencyB)))
  )
            ...
            {!showDetailed && (
              <>
                ...
                <LightCard>
                  <AutoColumn gap="10px">
                    <RowBetween>
                      <Text color={theme.text2} fontSize={24} fontWeight={500}>
                        {formattedAmounts[Field.CURRENCY_A] || '-'}
                      </Text>
                      <RowFixed>
                        <CurrencyLogo currency={currencyA} style={{ marginRight: '12px' }} />
                        <Text color={theme.text2} fontSize={24} fontWeight={500} id="remove-liquidity-tokena-symbol">
                          {currencyA?.symbol}
                        </Text>
                      </RowFixed>
                    </RowBetween>
                    <RowBetween>
                      ...
                      <RowFixed>
                        ...
                        <Text color={theme.text2} fontSize={24} fontWeight={500} id="remove-liquidity-tokenb-symbol">
                          {currencyB?.symbol}
                        </Text>
                      </RowFixed>
                    </RowBetween>
                    {chainId && (oneCurrencyIsWOMC || oneCurrencyIsOMC) ? (
                      <RowBetween style={{ justifyContent: 'flex-end' }}>
                        {oneCurrencyIsOMC ? (
                          <StyledInternalLink
                            to={`/remove/${currencyA === OMC ? WOMC[chainId].address : currencyIdA}/${
